...
<script>
    ...
    let uid = $page.params.uid || "100010001";
</script>
...
<Header company="Genshin" platformName="INFO QUERY" bind:isSideNavOpen>
    ...
    <HeaderNav>
        ...
        <HeaderNavItem href="/gameInfo/100010001" text="游戏信息" />
        <HeaderNavItem href="/charDetail/100010001" text="角色信息" />
        <HeaderNavMenu text="深渊">
            <HeaderNavItem href="/spiralAbyss1/100010001" text="本期" />
            <HeaderNavItem href="/spiralAbyss2/100010001" text="上期" />
        </HeaderNavMenu>
    </HeaderNav>
    ...
    <SideNav bind:isOpen={isSideNavOpen} rail>
        <SideNavItems>
            ...
            <SideNavMenu icon={Flash16} text="深渊">
                <SideNavMenuItem href={"/spiralAbyss1/" + uid} text="本期" />
                <SideNavMenuItem href={"/spiralAbyss2/" + uid} text="上期" />
            </SideNavMenu>
            <SideNavDivider />
        </SideNavItems>
    </SideNav>
